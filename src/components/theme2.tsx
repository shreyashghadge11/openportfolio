...
const Theme2: React.FC<{ portfolioData: PortfolioData }> = ({
  portfolioData,
}) => {
      ...
      <nav className='sticky p-4 '>
        <div className='container flex items-center justify-between mx-auto'>
          ...
          <div className='hidden space-x-4 lg:flex'>
            ...
            <a href='#skills' className='py-2 text-xl text-white font'>
              Skills
            </a>
            <a href='#contact' className='py-2 text-xl text-white font'>
              Contact Me
            </a>
            <a
              href='#contact'
              className='px-4 py-2 text-black bg-white border rounded-full'
            >
              Hire Me
            </a>
          </div>
      ...
      >
        ...
        >
          ...
          <div className='flex justify-center'>
            <button className='flex items-center px-4 py-2 text-black bg-white rounded-full'>
